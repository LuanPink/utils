...
public class TableBanHang extends JTable {
	public DefaultTableModel tableModel;

	public TableBanHang() {
		setOpaque(false);
		setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Mã sản phẩm", "Tên sản phẩm", "Loại", "Size",
				"Màu sắc", "Chất liệu", "Đơn giá", "Số lượng tồn" }));
