...
public class TableLuuTam extends JTable {
	public DefaultTableModel tableModel;

	public TableLuuTam() {
		setOpaque(false);
		setModel(new DefaultTableModel(new Object[][] {}, new String[] {"Mã sản phẩm","Tên sản phẩm","Loại","Size","Màu sắc","Chất liệu","Đơn giá","Số lượng bán"}));
