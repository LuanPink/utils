...
public class TableThanhToan extends JTable {
	public DefaultTableModel tableModel;
	public TableThanhToan() {
		setOpaque(false);
		setModel(new DefaultTableModel(new Object[][] {}, new String[] {"ID","Tên sản phẩm","Loại","Size","Màu sắc","Chất liệu","Đơn giá","Số lượng bán"})); 
		...
		getColumnModel().getColumn(7).setPreferredWidth(130);
		action();
	}
