...
public class CellMonth extends JButton {
	...
	public CellMonth() {
		...
		addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(getMonth()+1<=6) {
					PanelCalenderEmployee.slide.show(new PanelDay(getMonth()+1,getYear()), SlideDate.AnimateType.TO_LEFT);
				}else{
					PanelCalenderEmployee.slide.show(new PanelDay(getMonth()+1,getYear()), SlideDate.AnimateType.TO_RIGHT);
				}
				PanelCalenderEmployee.month = getMonth()+1;
				PanelCalenderEmployee.year = getYear();
				PanelCalenderEmployee.index = 0;
				PanelCalenderEmployee.option = "Day";	
				PanelCalenderEmployee.showMonthYear();
			}
		});
	}
