...
public class ButtonCheckedSizeAndColor3 extends JButton {
	...
	public ButtonCheckedSizeAndColor3(int index) {
		this.index = index;
		setOpaque(false);
		...
		addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				 ...
				 PanelWarranty.indexselected3=index;
				 PanelWarranty.get_thue();
			}
		});
