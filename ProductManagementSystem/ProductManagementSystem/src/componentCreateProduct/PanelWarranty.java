...
public class PanelWarranty extends JPanel {
	...
	public ButtonShowAllNotification btnAddProduct;
	private Combobox comboBoxWarranty;
	private DefaultComboBoxModel comboBoxModel;
	public static int indexselected;
	private ButtonCheckedSizeAndColor3 btnYes;
	private ButtonCheckedSizeAndColor3 btnNo;
	public static int indexofthue;
	private int index = 1;
	...
	private JLabel lblerbaohanh;
	private JLabel lblerthue;
	private static JPanel panelthue =new JPanel();
	public static int indexselected3;
	private JLabel lberchitiet;
	...
	public PanelWarranty() {
		...
		lblerbaohanh = new JLabel("");
		lblerbaohanh.setForeground(new Color(255, 0, 0));
		lblerbaohanh.setFont(new Font("Dialog", Font.ITALIC, 12));
		
		lberchitiet = new JLabel("");
		lberchitiet.setForeground(Color.RED);
		lberchitiet.setFont(new Font("Dialog", Font.ITALIC, 12));
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(lberchitiet, GroupLayout.PREFERRED_SIZE, 254, GroupLayout.PREFERRED_SIZE)
						...
						.addComponent(lblTitle, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 798, Short.MAX_VALUE)
						.addComponent(comboBoxWarranty, Alignment.LEADING, 0, 798, Short.MAX_VALUE)
						.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
							.addComponent(lblWarranty, GroupLayout.PREFERRED_SIZE, 164, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED, 470, Short.MAX_VALUE)
							.addComponent(lblerbaohanh, GroupLayout.PREFERRED_SIZE, 164, GroupLayout.PREFERRED_SIZE))
						.addComponent(panelthue, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 515, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblDetail, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 604, GroupLayout.PREFERRED_SIZE)
						.addComponent(panelDescriber, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 798, Short.MAX_VALUE))
					.addContainerGap())
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(lblWarranty, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
							.addGap(18))
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(lblerbaohanh, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)))
					.addComponent(comboBoxWarranty, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(panelthue, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(lblDetail, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
					.addGap(10)
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(14)
							.addComponent(lberchitiet, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)))
					.addGap(42))
		);
				...
				btnYes = new ButtonCheckedSizeAndColor3(1);
		
				btnNo = new ButtonCheckedSizeAndColor3(2);
		...
		lblerthue = new JLabel("");
		lblerthue.setForeground(Color.RED);
		lblerthue.setFont(new Font("Dialog", Font.ITALIC, 12));
		GroupLayout gl_panelthue = new GroupLayout(panelthue);
		gl_panelthue.setHorizontalGroup(
			gl_panelthue.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelthue.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panelthue.createParallelGroup(Alignment.LEADING)
						.addComponent(lblVat, GroupLayout.PREFERRED_SIZE, 379, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panelthue.createSequentialGroup()
						...
						.addGroup(gl_panelthue.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(lblNo))
						.addComponent(lblerthue, GroupLayout.PREFERRED_SIZE, 164, GroupLayout.PREFERRED_SIZE))
					.addContainerGap(126, Short.MAX_VALUE))
		);
		gl_panelthue.setVerticalGroup(
			gl_panelthue.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelthue.createSequentialGroup()
					.addContainerGap()
					...
					.addGroup(gl_panelthue.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnNo, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(lblerthue, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
					.addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
		);
		panelthue.setLayout(gl_panelthue);
	...
	public void setColorButtonModeDark(ButtonCheckedSizeAndColor3 button) {
		button.setColorBackground(ColorBackground.colorDark);	
		button.setColorhover1(ColorBackground.colorGRB394348);
	}
	...
	public void setColorButtonModeLight(ButtonCheckedSizeAndColor3 button) {
		button.setColorBackground(ColorBackground.colorLight);
		button.setColorhover1(ColorBackground.colorGRB181228202);
	}
	public void Check() {
		
new PanelTitleProduct().CheckNameProduct();
	}
	...
	public static void get_thue() {
		for (Component comp : panelthue.getComponents()) {
			if (comp instanceof ButtonCheckedSizeAndColor3) {
				ButtonCheckedSizeAndColor3 btn = (ButtonCheckedSizeAndColor3) comp;
				if (btn.index == indexselected3) {
	...
	public int checkthue() {
		if(indexofthue==0) {
			lblerthue.setText("Xin chọn thuế");
		}else if(indexofthue==1) {
			lblerthue.setText("");
			return 10;
		}else if(indexofthue==2) {
			lblerthue.setText("");
			return 5;
		}
		return 0;
	}
	public String CheckBaohanh() {
		String bh=comboBoxWarranty.getSelectedItem()+"";
		String bhT=null;
		if(comboBoxWarranty.getSelectedItem()=="Tháng") {
			lblerbaohanh.setText("Xin chọn tháng bảo hành");
		}else {
			bhT=bh;
			lblerbaohanh.setText("");
		}
		return bhT; 
}
	public String CheckDecribe() {
		String chitiet=txtDescriber.getText();
		if(chitiet.length()==0) {
			lberchitiet. setText("Xin nhập mô tả sản phẩm");
			return null;
		}else {
			lberchitiet.setText("");
			return chitiet;
