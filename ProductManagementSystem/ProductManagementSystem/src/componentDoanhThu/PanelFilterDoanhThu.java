...
public class PanelFilterDoanhThu extends JPanel {
	...
	private static Icon iconDeleteWhite = new ImageIcon(ButtonProductList.class.getResource("/icon/close.png"));
	public Combobox comboBox;
	public DefaultComboBoxModel comboBoxModel = new DefaultComboBoxModel();
	public static ButtonShowAllNotification btnApply = new ButtonShowAllNotification("Áp dụng"); 
	public static ButtonCheckedSizeAndColor btnNo = new ButtonCheckedSizeAndColor(0);
	public static ButtonCheckedSizeAndColor btnYes = new ButtonCheckedSizeAndColor(1);
	public static IconEditProduct btnClose = new IconEditProduct(iconDeleteWhite);
	...
	public PanelFilterDoanhThu(int year) {
		this.year = year;
		setOpaque(false);
