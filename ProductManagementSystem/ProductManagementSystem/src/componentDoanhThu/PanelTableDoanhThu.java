...
public class PanelTableDoanhThu extends JPanel {
	...
	public PanelTableDoanhThu() {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
				groupLayout.createSequentialGroup().addContainerGap().addGroup(groupLayout
						.createParallelGroup(Alignment.TRAILING).addComponent(scrollPane, Alignment.LEADING)
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addContainerGap()
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(btnFilter, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE))
						.addGap(11).addComponent(scrollPane, GroupLayout.DEFAULT_SIZE, 428, Short.MAX_VALUE)));
	...
	public void fillTable() {
		...
		for (ModelDoanhThu data : datas) {
			table.tableModel.addRow(new Object[] { data.getMonth(), data.getSpBan(), data.getTotalPrice(),
					data.getTotalNhapHang(), data.getLoiNhuan() });
		}
	}
	...
	public void action() {
		...
		btnFilter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// show
				showChart = new DiaLogShowChart(null, year);
		...
		PanelFilterDoanhThu.btnClose.addActionListener(new ActionListener() {
	...
	public void setData() {
		for (ModelDoanhThu data : datas) {
			chart.addData(new ModelChart("Tháng " + data.getMonth(),
					new double[] { Double.parseDouble(data.getTotalPrice() + ""),
							Double.parseDouble(data.getTotalNhapHang() + ""),
							Double.parseDouble(data.getLoiNhuan() + "") }));
		}
		chart.start();
	}
