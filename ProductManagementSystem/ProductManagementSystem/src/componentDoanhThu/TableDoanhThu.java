...
public class TableDoanhThu extends JTable {
		public DefaultTableModel tableModel;

		public TableDoanhThu() {
			setOpaque(false);
			setModel(new DefaultTableModel(new Object[][] {}, new String[] {"Tháng","Sản Phẩm Bán","Tổng Giá Bán","Tổng Nhập Hàng","Lợi Nhuận"})); 	
