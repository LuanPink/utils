...
public class PanelCalenderEmployee extends JPanel {
	...
	public PanelCalenderEmployee() {
		...
		btnClose.setIcon(new ImageIcon(PanelCalenderEmployee.class.getResource("/icon/close.png")));
		...
		btnNext = new AnimationButtonList(new ImageIcon(PanelCalenderEmployee.class.getResource("/icon/next.png")), "");
		...
		btnPrev = new AnimationButtonList(new ImageIcon(PanelCalenderEmployee.class.getResource("/icon/back.png")), "");
