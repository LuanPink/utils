...
public class TableCTHDBH extends JTable{

	public DefaultTableModel tableModel;
	public TableCTHDBH() {
		setOpaque(false);
		setModel(new DefaultTableModel(new Object[][] {}, new String[] {"ID","Tên Sản Phẩm","Tên Khách Hàng","Size","Màu Sắc","Chất Liệu","Số Lượng","Giá Tiền"})); 
