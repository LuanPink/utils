...
public class MainSignUp extends JFrame {
	...
	public JPanel body;
	private PanelSignUp panelVietnamese;
	...
	public MainSignUp() {
		...
		panelVietnamese = new PanelSignUp();
	...
	public void actionButton() {
		...
		dialog.addActionButtonEnglish(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				panelVietnamese.setLanguageEnglish();
				panelVietnamese.English();
				dialog.setVisible(false);
			}
		});
		...
		dialog.addActionButtonVietnamese(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				panelVietnamese.setLanguageVietnamese();
				panelVietnamese.vietnam();
				dialog.setVisible(false);
			}
		});
