...
public class CellProductColor extends TableCustomCell {
	...
	private DAOProductColor dao = new DAOProductColor();
	private ArrayList<ModelProductColor> datas = new ArrayList<ModelProductColor>();

	public CellProductColor() {
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGap(0, 430, Short.MAX_VALUE));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGap(0, 30, Short.MAX_VALUE));
	...
	public void initCombobox() {
		...
		for (ModelProductColor data : datas) {
			comboBoxModel.addElement(data.getNameColor());
		}
	...
	public TableCustomCell createComponentCellEditor(TableCustom arg0, TableRowData arg1, Object o, int arg3,
			int arg4) {
		CellProductColor cell = new CellProductColor();
		cell.setData(o);
		return cell;
	}
	...
	public Object getData() {
		...
		return new ModelProductColor(name);
	}

	@Override
	public void setData(Object o) {
		if (o != null) {
			ModelProductColor data = (ModelProductColor) o;
			comboBoxModel.setSelectedItem(data.getNameColor());
		}
	}
}
