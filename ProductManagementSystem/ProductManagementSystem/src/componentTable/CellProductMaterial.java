...
public class CellProductMaterial extends TableCustomCell {
	...
	private DAOProductMaterial dao = new DAOProductMaterial();
	private ArrayList<ModelProductMaterial> datas = new ArrayList<ModelProductMaterial>();
	public CellProductMaterial() {
	...
	public void initCombobox() {
		...
		for (ModelProductMaterial data : datas) {
			comboBoxModel.addElement(data.getNameMeterial());
		}
	...
	public TableCustomCell createComponentCellEditor(TableCustom arg0, TableRowData arg1, Object o, int arg3,
			int arg4) {
		CellProductMaterial cell = new CellProductMaterial();
		cell.setData(o);
		return cell;
	}
	...
	public Object getData() {
		...
		return new ModelProductMaterial(name);
	}

	@Override
	public void setData(Object o) {
		if (o != null) {
			ModelProductMaterial data = (ModelProductMaterial) o;
			comboBoxModel.setSelectedItem(data.getNameMeterial());
		}
	}
}
