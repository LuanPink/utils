...
public class CellProductSupplier extends TableCustomCell {
	...
	private ArrayList<ModelSupplier> datas = new ArrayList<ModelSupplier>();
	public CellProductSupplier() {
	...
	public void initCombobox() {
		...
		for (ModelSupplier data : datas) {
			comboBoxModel.addElement(data.getName());
		}
	...
	public TableCustomCell createComponentCellEditor(TableCustom arg0, TableRowData arg1, Object o, int arg3,
			int arg4) {
		CellProductSupplier cell = new CellProductSupplier();
		cell.setData(o);
		return cell;
	}
	...
	public Object getData() {
		...
		return new ModelSupplier(name);
	}

	@Override
	public void setData(Object o) {
		if (o != null) {
			ModelSupplier data = (ModelSupplier) o;
			comboBoxModel.setSelectedItem(data.getName());
		}
	}
}
