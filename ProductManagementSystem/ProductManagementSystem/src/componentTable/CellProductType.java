...
public class CellProductType extends TableCustomCell {
	...
	private DAOProductType dao = new DAOProductType();
	private ArrayList<ModelProductType> datas = new ArrayList<ModelProductType>();

	public CellProductType() {
	...
	public void initCombobox() {
		...
		for (ModelProductType data : datas) {
			comboBoxModel.addElement(data.getNameType());
		}
	...
	public TableCustomCell createComponentCellEditor(TableCustom arg0, TableRowData arg1, Object o, int arg3,
			int arg4) {
		CellProductType cell = new CellProductType();
		cell.setData(o);
		return cell;
	}
	...
	public Object getData() {
		...
		return new ModelProductType(name);
	}

	@Override
	public void setData(Object o) {
		if (o != null) {
			ModelProductType data = (ModelProductType) o;
			comboBoxModel.setSelectedItem(data.getNameType());
		}
	}
}
