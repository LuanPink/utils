...
public class TableTH extends JTable {
		public DefaultTableModel tableModel;

		public TableTH() {
			setOpaque(false);
			setModel(new DefaultTableModel(new Object[][] {}, new String[] {"Mã sản phẩm","Tên sản phẩm","Số lượng trả","Size","Màu sắc","Chất liệu","Tổng Tiền"}));
