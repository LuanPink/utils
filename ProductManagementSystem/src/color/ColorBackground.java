...
public class ColorBackground {
	public static Color colorLight = new Color(252,252,252);
	...
	public static Color colorGRB100100100 = new Color(100,100,100);
	
	public static Color colorGRB200200200 = new Color(200,200,200);
	
	public static Color colorGRB239239239 = new Color(239,239,239);
	
	public static Color colorGRB244244244 = new Color(244,244,244);
	
	public static Color colorGRB255255255 = new Color(255,255,255);
	
	public static Color colorGRB252252239 = new Color(252, 252, 239);
