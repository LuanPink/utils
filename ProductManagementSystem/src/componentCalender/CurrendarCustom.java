...
public class CurrendarCustom extends JLayeredPane{
	...
	public CurrendarCustom() {	
			...
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(slide, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE)))
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(slide, GroupLayout.DEFAULT_SIZE, 500, Short.MAX_VALUE))
				.addComponent(panel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		);
		
		AnimationButtonList btnNext = new AnimationButtonList(new ImageIcon(CurrendarCustom.class.getResource("/icon/next.png")),"");
		...
		AnimationButtonList btnPrev = new AnimationButtonList(new ImageIcon(CurrendarCustom.class.getResource("/icon/back.png")),"");
		...
		lblMonthAndYear.setForeground(ColorBackground.colorLight);
