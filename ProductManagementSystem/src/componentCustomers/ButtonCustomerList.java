...
public class ButtonCustomerList extends JButton {
	...
	public ButtonCustomerList(Icon icon, String username, String email, String phone, String buys, String total,
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addGroup(groupLayout
				...
				.addComponent(avatar, GroupLayout.PREFERRED_SIZE, 104, GroupLayout.PREFERRED_SIZE)
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addGroup(Alignment.LEADING,
				groupLayout.createSequentialGroup().addContainerGap().addGroup(groupLayout
						...
						.addGroup(groupLayout.createSequentialGroup()
								.addComponent(avatar, GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE).addContainerGap())
						.addGroup(groupLayout.createSequentialGroup().addGroup(groupLayout
								.createParallelGroup(Alignment.BASELINE).addComponent(lblUsername)
								...
								.addPreferredGap(ComponentPlacement.RELATED).addComponent(lblUsername_1,
		...
		addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				if (MainForm.mode == "Light") {
					setColor(ColorBackground.colorGRB239239239);
				} else {
					setColor(ColorBackground.colorGRB585961);
				}
