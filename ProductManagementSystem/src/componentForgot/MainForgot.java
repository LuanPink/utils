...
public class MainForgot extends JFrame {
	...
	private ImageIcon imageLogoShop = new ImageIcon(new ImageIcon(MainForgot.class.getResource("/icon/logo-shop.png"))
	...
	public MainForgot() {
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addComponent(body,
				GroupLayout.DEFAULT_SIZE, 813, Short.MAX_VALUE));
		...
		gl_panelNorth.setHorizontalGroup(
				gl_panelNorth.createParallelGroup(Alignment.TRAILING).addGap(0, 1000, Short.MAX_VALUE)
		...
		gl_panelNorth
				.setVerticalGroup(gl_panelNorth.createParallelGroup(Alignment.LEADING).addGap(0, 25, Short.MAX_VALUE)
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup().addContainerGap()
						.addComponent(btnLogin, GroupLayout.PREFERRED_SIZE, 154, GroupLayout.PREFERRED_SIZE).addGap(170)
		...
		panelBody.setBounds(210, 142, 550, 350);
		panelForgotPassword = new PanelForgotPassword();
		panelForgotPassword.setBounds(0, 0, 550, 350);

		panelBody.add(panelForgotPassword);
		body.add(panelBody);
		GroupLayout gl_panelBody = new GroupLayout(panelBody);
		gl_panelBody.setHorizontalGroup(
				gl_panelBody.createParallelGroup(Alignment.LEADING).addGap(0, 730, Short.MAX_VALUE));
		gl_panelBody
				.setVerticalGroup(gl_panelBody.createParallelGroup(Alignment.LEADING).addGap(0, 328, Short.MAX_VALUE));
	...
	public void actionButton() {
		...
		dialog.addActionButtonEnglish(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				panelForgotPassword.setLanguageEnglish();

				if (panelForgotPassword.selectedButtonContinue) {
					PanelContinueChangePassword.setLanguageEnglish();
				}
				dialog.setVisible(false);
			}
		});
		...
		dialog.addActionButtonVietnamese(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				panelForgotPassword.setLanguageVietNamese();

				if (panelForgotPassword.selectedButtonContinue) {
					PanelContinueChangePassword.setLanguageVietNamese();
				}
		...
		btnMinimize.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				btnMinimize.setBackground(Color.decode("#f5af19"));
		...
		panelNorth.addMouseMotionListener(new MouseAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
				...
				xScreen = currCoords.x - mouseDownCompCoords.x + 719;
