...
public class CellidProduct extends TableCustomCell {
	private TextField textField;
	private PanelTitle panel;

	public CellidProduct() {
		...
		textField.setHint("Mã sản phẩm");
		textField.setForeground(ColorBackground.colorLight);
		textField.setCaretColor(ColorBackground.colorLight);

		textField.setBorder(null);
		GroupLayout gl_panel = new GroupLayout(panel);
		gl_panel.setHorizontalGroup(
				gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel.createSequentialGroup()
						.addContainerGap().addComponent(textField, GroupLayout.DEFAULT_SIZE, 420, Short.MAX_VALUE)));
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addComponent(textField,
	...
	public TableCustomCell createComponentCellEditor(TableCustom arg0, TableRowData arg1, Object o, int arg3,
			int arg4) {
		CellidProduct cell = new CellidProduct();
		cell.setData(o);
		return cell;
	}
	...
	public Object getData() {
		return new ModelProductId(textField.getText());
	}

	@Override
	public void setData(Object o) {
		if (o != null) {
			ModelProductId data = (ModelProductId) o;
			textField.setHint("");
			textField.setText(data.getId());
		}
	}
}
