...
public class TableHDTH extends JTable {
		public DefaultTableModel tableModel;

		public TableHDTH() {
			setOpaque(false);
			setModel(new DefaultTableModel(new Object[][] {}, new String[] {"Mã Hóa Đơn","Mã sản phẩm","Tên sản phẩm","Size","Màu sắc","Chất liệu","Số lượng","Đơn giá"}));
