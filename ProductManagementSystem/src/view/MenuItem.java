...
public class MenuItem extends JPanel {
	...
	private int index;
	private static Color colorMenuItem = ColorBackground.colorDark;
	private static Color colorArrow = new Color(100, 100, 100);
	...
	public static void setColorMenuItem(Color colorMenuItem) {
		MenuItem.colorMenuItem = colorMenuItem;
	}
	...
	public static void setColorArrow(Color colorArrow) {
		MenuItem.colorArrow = colorArrow;
	}
