...
public class PanelHeader extends JPanel {
	...
	ImageIcon image = new ImageIcon(new ImageIcon(PanelHeader.class.getResource("/icon/vulee.jpg")).getImage().getScaledInstance(80, 80, Image.SCALE_SMOOTH));
	...
	public void actionButtonMode() {
		...
		lblMessage.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				dialogMessage = new DialogMessage(null, "Messenger",180);
				int x = 1060;
				int y = 80;
				MainForm.setLocationDialog(x, y);
				MainForm.setLocationMouseDragged(x, y);
				dialogMessage.setLocation(MainForm.xScreen, MainForm.yScreen);
		...
		lblNotification.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				dialogMessage = new DialogMessage(null, "Thông báo",180);
				int x = 1130;
				int y = 80;
				MainForm.setLocationDialog(x, y);
				MainForm.setLocationMouseDragged(x, y);
		...
		avatar.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				dialogMessage = new DialogMessage(null, "Profile",120);
				int x = 1240;
				int y = 80;
				MainForm.setLocationDialog(x, y);
				MainForm.setLocationMouseDragged(x, y);
